...
class SmartphoneController extends Controller
{
    public function all(Request $request){
        ...
        return ResponseFormatter::success(smartphone::first(), 'Data Smartphone Berhasil Diambil');
        // if($smartphone )
        // {
        //     return ResponseFormatter::success(smartphone::all(), 'Data Smartphone Berhasil Diambil');
        // }else{
        //     return ResponseFormatter::error(null, 'Data Smartphone Tidak Ditemukan', 404);
        // }
